...
const Instruction INSTRUCTIONS[] = {
    ...
    {"POP BC", OPCODE_POP_BC, BC, REGISTER, SP, REGISTER_INDIRECT, POP, LD_ST_MOV, 0, 1},
    ...
    {"RET Z", OPCODE_RET_Z, NONE, NA, NONE, NA, RET, JUMP, 4, 1},
    {"RET", OPCODE_RET, NONE, NA, NONE, NA, RET, JUMP, 0, 1},
    ...
    {"RST 0x08", OPCODE_RST_08H, NONE, NA, NONE, NA, RST, JUMP, UNCONDITIONAL, 8, 1},
    {"NA"},
    {"NA"},
    {"NA"},
    {"NA"},
