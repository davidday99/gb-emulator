...
const Instruction INSTRUCTIONS[] = {
    ...
    {"LD H,%d", OPCODE_LD_H_D8, H, REGISTER, D8, IMMEDIATE_MEM, LD, LD_ST_MOV, UNCONDITIONAL, 0, 2},
    ...
    {"LD SP,%d", OPCODE_LD_SP_D16, SP, REGISTER, D16, IMMEDIATE_MEM, LD, LD_ST_MOV, UNCONDITIONAL, 0, 3},
    ...
    {"ADD A,%d", OPCODE_ADD_A_D8, A, REGISTER, D8, IMMEDIATE_MEM, ADD, ALU, UNCONDITIONAL, 0, 2},
    ...
    {"ADC A,%d", OPCODE_ADC_A_D8, A, REGISTER, D8, IMMEDIATE_MEM, ADC, UNCONDITIONAL, 0, 2},
    ...
    {"SUB %d", OPCODE_SUB_D8, A, REGISTER, D8, IMMEDIATE_MEM, SUB, UNCONDITIONAL, 0, 2},
    ...
    {"NA"},
    {"SBC %d", OPCODE_SBC_A_D8, A, REGISTER, D8, IMMEDIATE_MEM, SBC, ALU, UNCONDITIONAL, 0, 2},
    ...
    {"AND %d", OPCODE_AND_D8, A, REGISTER, D8, IMMEDIATE_MEM, AND, ALU, UNCONDITIONAL, 0, 2},
    {"RST 0x20", OPCODE_RST_20H, 0x20, IMMEDIATE, NONE, NA, RST, JUMP, UNCONDITIONAL, 0, 1},
    {"ADD SP,%d", OPCODE_ADD_SP_R8, SP, REGISTER, D8, IMMEDIATE_MEM, ADD, ALU, UNCONDITIONAL, 0, 2},
    ...
    {"NA"},
    {"NA"},
    {"XOR %d", OPCODE_XOR_D8, A, REGISTER, D8, IMMEDIATE_MEM, XOR, ALU, UNCONDITIONAL, 0, 2},
    ...
    {"OR %d", A, REGISTER, D8, IMMEDIATE_MEM, OR, ALU, UNCONDITIONAL, 0, 2},
    {"RST 0x30", OPCODE_RST_20H, 0x30, IMMEDIATE, NONE, NA, RST, JUMP, UNCONDITIONAL, 0, 1},
    {"LD HL,SP+(%d)", OPCODE_LD_HL_SP_R8, HL, REGISTER, D8, IMMEDIATE_MEM, LDHL, LD_ST_MOV, UNCONDITIONAL, 4, 2},
