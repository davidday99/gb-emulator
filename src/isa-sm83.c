...
const Instruction INSTRUCTIONS[] = {
    ...
    {"LD (0x%04X),SP", OPCODE_LD_REF_A16_SP, A16, IMMEDIATE_MEM_INDIRECT, SP, REGISTER, LD, LD_ST_MOV, UNCONDITIONAL, 0, 3},
    ...
    {"ADC A,0x%02X", OPCODE_ADC_A_D8, A, REGISTER, D8, IMMEDIATE_MEM, ADC, UNCONDITIONAL, 0, 2},
    ...
    {"SUB 0x%02X", OPCODE_SUB_D8, A, REGISTER, D8, IMMEDIATE_MEM, SUB, UNCONDITIONAL, 0, 2},
    ...
    {"ADD SP,0x%02X", OPCODE_ADD_SP_R8, SP, REGISTER, D8, IMMEDIATE_MEM, ADD, ALU, UNCONDITIONAL, 0, 2},
    ...
    {"OR 0x%02X", A, REGISTER, D8, IMMEDIATE_MEM, OR, ALU, UNCONDITIONAL, 0, 2},
