...
const Instruction INSTRUCTIONS[] = {
    ...
    {"RET NZ", OPCODE_RET_NZ, NONE, NA, NONE, NA, RET, JUMP, NZ, 4, 1},
    ...
    {"CALL NZ,0x%04X", OPCODE_CALL_NZ_A16, A16, IMMEDIATE_MEM, NONE, NA, CALL, JUMP, NZ, 0, 3},
    ...
    {"CALL Z,0x%04X", OPCODE_CALL_Z_A16, A16, IMMEDIATE_MEM, NONE, NA, CALL, JUMP, Z, 0, 3},
    {"CALL 0x%04X", OPCODE_CALL_A16, A16, IMMEDIATE_MEM, NONE, NA, CALL, JUMP, UNCONDITIONAL, 0, 3},
    ...
    {"NA"},
    {"CALL NC,0x%04X", OPCODE_CALL_NC_A16, A16, IMMEDIATE_MEM, NONE, NA, CALL, JUMP, NC, 0, 3},
    ...
    {"NA"},
    {"CALL C,0x%04X", OPCODE_CALL_C_A16, A16, IMMEDIATE_MEM, NONE, NA, CALL, JUMP, CARRY, 0, 3},
    {"NA"},
    ...
    {"LD (0x%04X),A", OPCODE_LD_REF_A16_A, A16, IMMEDIATE_MEM_INDIRECT, A, REGISTER, LD, LD_ST_MOV, UNCONDITIONAL, 0, 3},
    {"NA"},
    {"NA"},
    {"NA"},
...
const Instruction CB_INSTRUCTIONS[] = {
    ...
    {"BIT 0,(HL)", OPCODE_BIT_0_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 1,(HL)", OPCODE_BIT_1_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 2,(HL)", OPCODE_BIT_2_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 3,(HL)", OPCODE_BIT_3_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 4,(HL)", OPCODE_BIT_4_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 5,(HL)", OPCODE_BIT_5_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 6,(HL)", OPCODE_BIT_6_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"BIT 7,(HL)", OPCODE_BIT_7_REF_HL, NONE, NA, HL, REGISTER_INDIRECT, BIT, BITWISE, UNCONDITIONAL, 4, 1},
    ...
    {"RES 3,A", OPCODE_RES_3_A, A, REGISTER, A, REGISTER, RES, BITWISE, UNCONDITIONAL, 0, 1},
    ...
    {"SET 5,(HL)", OPCODE_SET_5_REF_HL, HL, REGISTER_INDIRECT, HL, REGISTER_INDIRECT, SET, BITWISE, UNCONDITIONAL, 0, 1},
    ...
    {"SET 7,B", OPCODE_SET_7_B, B, REGISTER, B, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,C", OPCODE_SET_7_C, C, REGISTER, C, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,D", OPCODE_SET_7_D, D, REGISTER, D, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,E", OPCODE_SET_7_E, E, REGISTER, E, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,H", OPCODE_SET_7_H, H, REGISTER, H, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,L", OPCODE_SET_7_L, L, REGISTER, L, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,(HL)", OPCODE_SET_7_REF_HL, HL, REGISTER_INDIRECT, HL, REGISTER_INDIRECT, SET, BITWISE, UNCONDITIONAL, 0, 1},
    {"SET 7,A", OPCODE_SET_7_A, A, REGISTER, A, REGISTER, SET, BITWISE, UNCONDITIONAL, 0, 1},
};
