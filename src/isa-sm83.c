...
const Instruction INSTRUCTIONS[] = {
    ...
    {"RST 0x00", OPCODE_RST_00H, NONE, NA, NONE, NA, RST, JUMP, UNCONDITIONAL, 8, 1},
    ...
    {"RST 0x08", OPCODE_RST_08H, 0x08, IMMEDIATE, NONE, NA, RST, JUMP, UNCONDITIONAL, 8, 1},
    ...
    {"RST 0x10", OPCODE_RST_10H, 0x10, IMMEDIATE, NONE, NA, RST, JUMP, UNCONDITIONAL, 8, 1},
    ...
    {"NA"},
    {"SBC A,%d", OPCODE_SBC_A_D8, A, REGISTER, D8, IMMEDIATE_MEM, SBC, ALU, UNCONDITIONAL, 0, 2},
    {"RST 0x18", OPCODE_RST_18H, 0x18, IMMEDIATE, NONE, NA, RST, JUMP, UNCONDITIONAL, 8, 1},
